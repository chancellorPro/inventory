...
class IndexController extends Controller
{
    ...
    public function index(Request $request)
    {
        $data = $this->applyFilter(
            $request,
            Stock::selectRaw('count(a.id) as aggregate, stock.product_id, max(stock.partition) as partition, max(stock.count) as count, max(stock.description) as description, max(p.count) as plan_count, max(p.progress) as progress')
